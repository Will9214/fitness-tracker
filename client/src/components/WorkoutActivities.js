          ...
          <Container>
            ...
            <Row className="text-center align-items-center">
              ...
              <Col md={3}>
                ...
                <div>Sets</div>
                {isEditingSets ? (
                  <input name="sets" onChange={e => setEditedActivitySets(e.target.value)} value={editedActivitySets} onFocus={handleFocus} onKeyUp={handleEnter} onBlur={handleUpdateSets} autoFocus style={{ width: "50px" }}/>
                ) : (
